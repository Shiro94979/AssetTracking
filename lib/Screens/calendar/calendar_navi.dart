...
import '/Screens/calendar/calendarprocess.dart';
...
class CalendarNavi extends StatefulWidget {
  CalendarNavi({Key? key}) : super(key: key);

  @override
  State<CalendarNavi> createState() => _HomeState();
}

class _HomeState extends State<CalendarNavi> {
  int currentTab = 1;
  ...
  Widget currentScreens = CalendarProcess();
              ...
              Row(
                ...
                children: [
                  ...
                  MaterialButton(
                    ...
                    onPressed: () {
                      setState(() {
                        currentScreens = CalendarProcess();
                        currentTab = 1;
                      });
                    },
                    child: Column(
